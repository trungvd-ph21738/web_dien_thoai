...
<div>
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <a href="/color/view-add" class="btn btn-primary mb-3">Add Color</a>
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered first">
                            ...
                            <tbody>
                            <c:forEach items="${colorList}" var="color" varStatus="item">
                                <tr>
                                    <td>${item.index+1}</td>
                                    ...
                                    <td>
                                        <a href="/color/view-update?id=${color.id}" class="btn btn-brand">Update</a>
                                        <a href="/color/remove?id=${color.id}" class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
