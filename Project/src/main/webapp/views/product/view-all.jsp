...
<div>
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <a href="/product/view-add" class="btn btn-primary mb-3">Add Product</a>
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered first">
                            ...
                            <tbody>
                            <c:forEach items="${productList}" var="product" varStatus="item">
                                <tr>
                                    <td>${item.index+1}</td>
                                    ...
                                    <td>
                                        <a href="/product/view-update?id=${product.id}" class="btn btn-brand">Update</a>
                                        <a href="/product/remove?id=${product.id}" class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
